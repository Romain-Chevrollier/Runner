...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, type):
        ...
        if type == 'fly':
            ...
            snail_frame1 = pygame.image.load('assets/graphics/snail/snail1.png').convert_alpha()
            snail_frame2 = pygame.image.load('assets/graphics/snail/snail2.png').convert_alpha()
...
class projectile(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        self.image = pygame.image.load('assets/graphics/lazer.png').convert_alpha()
